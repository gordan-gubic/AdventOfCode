...
public class Day1502 : Day
{
    private const int YEAR = 2024;
    private const int DAY = 1502;
    ...
    public Day1502(ILog log, IParser parser) : base(log, parser, YEAR, DAY)
    {
        parser.Day = 15;
        ...
        ExpectedProd1 = "1426855";
        ExpectedProd2 = "1404917";
    }
