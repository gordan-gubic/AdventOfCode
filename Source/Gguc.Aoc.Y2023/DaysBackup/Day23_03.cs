...
public class Day23_03 : Day
{
    private const int YEAR = 2023;
    private const int DAY = 23_03;
    ...
    private Dictionary<(Point, Point), int> ShortPaths = new();
    private Dictionary<Point, List<Point>> Crossroads = new();

    public Day23_03(ILog log, IParser parser) : base(log, parser, YEAR, DAY)
    {
        EnableDebug();
        Initialize();
    ...
    private void CreateAddCache(Path path)
    {
        ...
        ShortPaths[(p0, p2)] = points.Count;
        ShortPaths[(p2, p0)] = points.Count;
